...
const Skills = () => {
  return (
    <>
    <h1 className="max-w-7xl mx-3 lg:mx-auto border-b-4 border-b-blue-600 text-4xl font-bold">Technical Skills & Tools</h1>
    <section className=' max-w-7xl mx-3 lg:mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-3 p-4'>
